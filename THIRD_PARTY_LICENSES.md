...
The MIT License in `LICENSE` applies only to the original Astral Attack source code. Third-party art, audio, fonts, libraries, and other assets remain under the terms listed below.
...
- [Health Bar — Basic Pixel Health Bar by BDragon1727](https://bdragon1727.itch.io/basic-pixel-health-bar-and-scroll-bar) — Free for use in non-commercial games
...
- [Buff Sprites — Celestial Objects by Useless Pursuit](https://uselesspursuit.itch.io/celestial-objects-pixel-art-pack) — May be used and modified in free and commercial projects; credit is appreciated but not required
...
- [Pixelbasel](https://fontesk.com/pixelbasel-font/) — SIL Open Font License 1.1

## Music

- [Space Shooter Music](https://opengameart.org/content/space-shooter-music) — Creative Commons Attribution 3.0
  - MUSIC BY OBLIDIVM — [Oblidivm Music](http://oblidivmmusic.blogspot.com.es/)
...
SFML includes or uses additional libraries under their own terms, including OpenAL Soft (LGPL), FreeType (FreeType License or GPL), libogg (BSD), libvorbis (BSD), libflac (BSD), stb (public domain), and minimp3 (CC0). See [SFML's dependency licenses](External/SFML-x64/license.md) and the upstream projects for their complete terms.
